...
# Utility function to run SQL query and return results
...
def upcoming_birthdays_section():
    ...
    for sid, name, dob in rows:
        # Adjust DOB year to this year for comparison
...
# Top-level navigation with Academic Calendar added
main_menu = st.sidebar.radio("Choose Section", [
    "Dashboard", 
    "Core Modules", 
    "Analytics & Reports", 
    "Student Insights",
    "Academic Calendar"   # ✅ Added here
])
...
if main_menu == "Dashboard":
    ...
    academic_calendar_section()  # ✅ Added here
